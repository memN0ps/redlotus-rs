...
pub const BlImgAllocateImageBufferSignature_2: &str = "48 89 5C 24 ? 55 56 57 41 54 41 55 41 56 41 57 48 8B EC 48 83 EC ? 4C 8B 39";

// OslFwpKernelSetupPhase1 for Windows 10
pub const OslFwpKernelSetupPhase1Signature_1: &str = "48 89 4C 24 ? 55 53 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 E1 48 81 EC ? ? ? ? 48 8B F1";

// OslFwpKernelSetupPhase1 for Windows 11
pub const OslFwpKernelSetupPhase1Signature_2: &str = "48 89 4C 24 ? 55 53 56 57 41 54 41 55 41 56 41 57 48 8D 6C 24 E1 48 81 EC ? ? ? ? 45 33 E4";
